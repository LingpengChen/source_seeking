...
plt.fill_between(days_gd_no, mean_greedy_no_prior - 80*variance_greedy_no_prior, mean_greedy_no_prior + 80*variance_greedy_no_prior, color='orange', alpha=0.5)
...
# print(mean_p[30], mean_greedy_no_prior[30], mean_c[30], mean_DoSS[30], mean_GMES[30])
# print(mean_p[60], mean_greedy_no_prior[60], mean_c[60], mean_DoSS[60], mean_GMES[60])
